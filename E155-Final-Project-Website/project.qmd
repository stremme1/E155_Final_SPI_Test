...
::: {.scroll-animate style="max-width: 800px; margin: 0 auto; text-align: center; padding: 0 var(--space-8); width: 100%; box-sizing: border-box;"}
...
![System Schematic](Images/Schemtaic.png){width="100%" style="margin: 2rem 0;"}

![Final Dual-Stick Embedded System Prototype](Images/Final Protoytpye assembly.png){width="100%" style="margin: 2rem 0;"}
:::
...
![FPGA Data Output Trace](Images/FPGAOUTPUT trace.png){width="100%" style="margin: 2rem 0;"}
...
![FPGA Top Module](Images/FPGA_TOPModuleblock.png){width="100%" style="margin: 2rem 0;"}
...
![MCU Flow Diagram](Images/MCUFlow diagram.png){width="100%" style="margin: 2rem 0;"}
...
![Drum Logic Table](Images/TableX_drum Sounds decoder left right.png){width="100%" style="margin: 2rem 0;"}

*Table: Drum detection logic for left and right hand sensors*
...
![Full Dual-Stick Embedded System Prototype](Images/Final Protoytpye assembly.png){width="100%" style="margin: 2rem 0;"}

*Figure: Full Dual-Stick Embedded System Prototype*

![User Testing of the Dual-Stick Invisible Drum Set Prototype](Images/Someone Playing drums.png){width="100%" style="margin: 2rem 0;"}

*Figure: User Testing of the Dual-Stick Invisible Drum Set Prototype*

![Final Prototype Assembly with Integrated Speaker Output](Images/Final demoday emmett marina.png){width="100%" style="margin: 2rem 0;"}
...
![Arduino Serial Monitor Sensor Data](Images/Arduino serial monitor.png){width="100%" style="margin: 2rem 0;"}
...
![Logic Analyzer with outputted SPI Protocol](Images/Logic Anlyser with .png){width="100%" style="margin: 2rem 0;"}
...
![spi_slave_mcu test pattern](Images/image1.png){width="100%" style="margin: 2rem 0;"}

*Figure: spi_slave_mcu test pattern*

![Segger Debug Terminal outputting MCU receiving the correct test pattern](Images/image2.png){width="100%" style="margin: 2rem 0;"}
...
![MCU Debug Terminal output displaying the 16-byte SPI packet](Images/image3.png){width="100%" style="margin: 2rem 0;"}
...
![Logic Analyzer showcasing the SPI Protocol](Images/image4.png){width="100%" style="margin: 2rem 0;"}
...
![Initialization of all drum sounds outputted by the DAC](Images/image5.png){width="100%" style="margin: 2rem 0;"}
...
![BNO085 information on the digikey website](Images/image6.jpg){width="100%" style="margin: 2rem 0;"}
...
::: {.scroll-animate style="margin-bottom: 4rem; padding-bottom: 2rem;"}
...
![FSM for the BNO085_controller.sv](Images/image7.jpg){width="100%" style="margin: 2rem 0;"}

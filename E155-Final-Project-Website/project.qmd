...
![System Schematic](Images/image23.png){width="100%" style="margin: 2rem 0;"}

*Figure: Schematic diagram of the System*

![Final Dual-Stick Embedded System Prototype](Images/image13.png){width="100%" style="margin: 2rem 0;"}
:::
...
![FPGA Top Module](Images/image12.png){width="100%" style="margin: 2rem 0;"}
...
![MCU Flow Diagram](Images/image19.png){width="100%" style="margin: 2rem 0;"}
...
![Full Dual-Stick Embedded System Prototype](Images/image13.png){width="100%" style="margin: 2rem 0;"}

*Figure: Full Dual-Stick Embedded System Prototype*

![User Testing of the Dual-Stick Invisible Drum Set Prototype](Images/image22.jpg){width="100%" style="margin: 2rem 0;"}

*Figure: User Testing of the Dual-Stick Invisible Drum Set Prototype*

![Final Prototype Assembly with Integrated Speaker Output](Images/image16.png){width="100%" style="margin: 2rem 0;"}
...
![spi_slave_mcu test pattern](Images/image3.png){width="100%" style="margin: 2rem 0;"}

*Figure: spi_slave_mcu test pattern*

![Segger Debug Terminal outputting MCU receiving the correct test pattern](Images/image17.jpg){width="100%" style="margin: 2rem 0;"}
...
![MCU Debug Terminal output displaying the 16-byte SPI packet](Images/image10.png){width="100%" style="margin: 2rem 0;"}
...
![Initialization of all drum sounds outputted by the DAC](Images/image18.png){width="100%" style="margin: 2rem 0;"}
...
![BNO085 information on the digikey website](Images/image9.png){width="100%" style="margin: 2rem 0;"}
...
![FSM for the BNO085_controller.sv](Images/image2.png){width="100%" style="margin: 2rem 0;"}
